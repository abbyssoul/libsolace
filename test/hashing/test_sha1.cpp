...
TEST(TestHashingSHA1, hashEmptyMessage) {
    ...
    EXPECT_EQ(MessageDigest({0xda, 0x39, 0xa3, 0xee, 0x5e, 0x6b, 0x4b, 0x0d, 0x32, 0x55,
...
TEST(TestHashingSHA1, hashSingleLetter) {
    ...
    EXPECT_EQ(MessageDigest({ 0x86, 0xf7, 0xe4, 0x37, 0xfa, 0xa5, 0xa7, 0xfc, 0xe1, 0x5d,
...
TEST(TestHashingSHA1, hashAx1000) {
    ...
    EXPECT_EQ(MessageDigest({ 0x29, 0x1e, 0x9a, 0x6c, 0x66, 0x99, 0x49, 0x49, 0xb5, 0x7b,
...
TEST(TestHashingSHA1, hashABC) {
    ...
    EXPECT_EQ(MessageDigest({0xA9, 0x99, 0x3E, 0x36, 0x47, 0x06, 0x81, 0x6A, 0xBA, 0x3E,
...
TEST(TestHashingSHA1, hashMessageDigest) {
    ...
    EXPECT_EQ(MessageDigest({0x84, 0x98, 0x3E, 0x44, 0x1C, 0x3B, 0xD2, 0x6E, 0xBA, 0xAE,
