...
public:
    ...
    void hashEmptyMessage() {
        ...
        CPPUNIT_ASSERT_EQUAL(MessageDigest({ 0xe3, 0xb0, 0xc4, 0x42, 0x98, 0xfc, 0x1c, 0x14,
    ...
    void hashSingleLetter() {
        ...
        CPPUNIT_ASSERT_EQUAL(MessageDigest({0xca, 0x97, 0x81, 0x12, 0xca, 0x1b, 0xbd, 0xca,
    ...
    void hashABC() {
        ...
        CPPUNIT_ASSERT_EQUAL(MessageDigest({0xBA, 0x78, 0x16, 0xBF, 0x8F, 0x01, 0xCF, 0xEA,
    ...
    void hashMessageDigest() {
        ...
        CPPUNIT_ASSERT_EQUAL(MessageDigest({0x24, 0x8D, 0x6A, 0x61, 0xD2, 0x06, 0x38, 0xB8,
...
CPPUNIT_TEST_SUITE_REGISTRATION(TestHashingSHA256);
